...
namespace SchoolManagementSystem.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,AdmissionNumber,FirstName,LastName,DateOfBirth,JoinedDate,Email,PhoneNumber,About,Image")] Student student)
        {
